      ...
      projectListInProgress: [
        {
          ...
          technologies: "C++",
          text:
            "This is a class project for a machine learning class. I will be responsible for building a nerual network that uses a single layer."
        },
        {
          title: "Living Dungeons and Dragons Database",

          technologies:
            "React, Js, MongoDB, Stanford NLP Toolsuite, and Prolog",
          text:
