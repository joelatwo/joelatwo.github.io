...
const project: Project = {
  ...
  "description": "A series of react components that make the foundational building blocks to increase speed and consistency.",
  "status": "",
  "content": [
    {
      "type": "paragraph",
